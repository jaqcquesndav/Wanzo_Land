...
export function Testimonials() {
  return (
    <section className="relative w-full py-24 overflow-visible" style={{ background: 'linear-gradient(180deg, #f3f4f6 0%, #e5e7eb 100%)' }}>
      ...
      <div className="relative z-10 pt-8">
        <Container>
          ...
          <div className="mx-auto mt-16 mb-8 w-full max-w-6xl px-2 sm:px-0">
